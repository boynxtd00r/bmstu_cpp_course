...
class list
{
   ...
   public:
	...
	{
		using Base =
			abstract_iterator<iterator, T, std::bidirectional_iterator_tag>;
	...
	struct const_iterator
		: public abstract_iterator<const_iterator,
								   const T,
								   std::bidirectional_iterator_tag>
	{
		using Base = abstract_iterator<const_iterator,
									   const T,
									   std::bidirectional_iterator_tag>;
		using difference_type = typename Base::difference_type;
		using reference = typename Base::reference;
		...
		const_iterator(const iterator& it)
			: current(it.current) {}  // Conversion from iterator
	...
	list& operator+=(list&& other) noexcept { return *this += other; }
